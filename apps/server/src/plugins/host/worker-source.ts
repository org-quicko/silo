...
export class WorkerSource {
  ...
  private static readonly Epilogue = [
    ...
    "      }",
    "      config = msg.config;",
    "      // Hooks and routes are one list here: both are functions on the same",
    "      // default export, named exactly as the manifest names them, and the",
    "      // host's reconcile asks the same question about each.",
