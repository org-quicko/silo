...
describe('Routes.parse', () => {
  test.each([
    ...
    ['/servers/s1/settings/media-storage', 'server-settings:media-storage'],
    ['/servers/s1/settings/configuration', 'server-settings:configuration'],
    ['/servers/s1/settings/ai-assistants', 'server-settings:ai-assistants'],
...
describe('Routes builders', () => {
  test.each([
    ...
    [Routes.serverSettings('s1', 'media-storage'), 'server-settings:media-storage'],
    [Routes.serverSettings('s1', 'configuration'), 'server-settings:configuration'],
    [Routes.serverSettings('s1', 'ai-assistants'), 'server-settings:ai-assistants'],
