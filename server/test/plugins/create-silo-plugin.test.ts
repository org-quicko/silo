...
import { ManifestReader, SiloApi } from "../../plugins";
...
import { OptionsResolver } from "../../../create-silo-plugin/src/options-resolver";
import { Arguments } from "../../../create-silo-plugin/src/arguments";
...
describe("create-silo-plugin output", () => {
  ...
  test("the version range it defaults to admits the silo it was cut alongside", async () => {
    ...
    const { PluginLoader } = await import("../../plugins");
