/// Every route this client reaches, and every route it leaves out on purpose.
/// Held to the TypeScript client's lists by a test.
abstract final class RouteInventory {
  static const covered = <String>[
    'GET /api/health',
    'GET /api/projects',
    'POST /api/projects',
  ...
  static const outOfScope = <String, String>{
  ...
  static bool accountsFor(String route) => covered.contains(route) || outOfScope.containsKey(route);
}
